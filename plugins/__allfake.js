...
handler.all = async function (m) {
	let pp = 'https://telegra.ph/file/edf753b91ea9496341b4e.png'
	try {
		...
		global.kontak2 = [
         [owner[0], await this.getName(owner[0] + '@s.whatsapp.net'), 'ARDev', '4rdhan08@gmail.com', true],
         [owner[1], await this.getName(owner[1] + '@s.whatsapp.net'), 'ARDev', '4rdh4n08@gmail.com', true], // Kalo mau di tambah tinggal copy 1baris ini di tempel di bawahnya trs di edit dikit!
        ]
